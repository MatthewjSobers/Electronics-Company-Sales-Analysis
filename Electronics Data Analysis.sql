...
--WHICH PRODUCTS TYPES HAVE THE HIGHEST RATING AND HOW DOES IT CORRELATE WITH SALES VOLUME
SELECT P.PRODUCT_TYPE, AVG(O.RATING) AS AVG_RATING, SUM(TOTAL_PRICE) AS TOTAL_SALES, COUNT(*) AS ITEMS_BOUGHT
FROM PRODUCT P
JOIN ORDERS O
ON P.PRODUCT_ID = O.PRODUCT_ID
...
--WHICH PRODUCT_TYPES ARE MORE AFFECTED BY UNIT PRICE IN TERMS OF UNITS SOLD
SELECT DISTINCT P.PRODUCT_TYPE, P.UNIT_PRICE, 
SUM(O.QUANTITY) AS UNITS_SOLD
FROM PRODUCT P
JOIN ORDERS O
ON P.PRODUCT_ID = O.PRODUCT_ID
GROUP BY PRODUCT_TYPE, P.UNIT_PRICE
ORDER BY UNITS_SOLD DESC;
...
--WHAT WHERE THE MOST USED PAYEMENT METHODS AND WHICH SPENT THE MOST
SELECT PAYMENT_METHOD, COUNT(PAYMENT_METHOD) AS METHOD_COUNT, AVG(TOTAL_PRICE), SUM(TOTAL_PRICE)
FROM ORDERS
GROUP BY PAYMENT_METHOD
ORDER BY METHOD_COUNT DESC;

-- What is average rating for customers who purchased add-ons and those who didn't
